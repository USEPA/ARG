...
setwd("C:/Users/rmartin/OneDrive - Environmental Protection Agency (EPA)/Documents/Dorazio_Dilution")
...
```{stan bin_dilution_model_pp_g_o, echo=TRUE, message=FALSE, warning=FALSE, output.var="Bin_dilution_pp_g_slopes"}
data{
 int<lower=1> N;  // number of observations
 int<lower=1> U; //number unique standard concentrations
 int<lower=0> y[N];  // n success
